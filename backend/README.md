...
## Project Structure
    ...
    ├── frosty_glade_dev_104857  # Django project configurations
...
1. Clone this repo and `cd frosty_glade_dev_104857`
...
2. Clone this repo and `cd frosty_glade_dev_104857`
